...
namespace fsh {
    namespace {
        ...
        struct point_helpers {
            ...
            static constexpr point<d, Int> index_to_point(Int index, Int width,
                                                          Int max) {
                point<d, Int> output;
                max /= width;
                for (uint i = 0; i < d; i++) {
        ...
        struct point_helpers<2, Int> {
            ...
            static constexpr point<2, Int> index_to_point(Int index, Int width,
                                                          Int max) {
        ...
        struct point_helpers<3, Int> {
            ...
            static constexpr point<3, Int> index_to_point(Int index, Int width,
                                                          Int max) {
    ...
    constexpr Int point_to_index(const point<d, Int>& p, Int width, Int max) {
        ...
        return point_helpers<d, Int>::point_to_index(point<d, Int>(p),
                                                     Int(width), max);
    }

    template <uint d, class IntS, class IntL>
    constexpr IntL point_to_index(const point<d, IntL>& p, IntS width,
                                  IntL max) {
        static_assert(sizeof(IntS) <= sizeof(IntL),
                      "IntS must be smaller or equal to IntL");
        return point_helpers<d, IntL>::point_to_index(point<d, IntL>(p),
                                                      IntL(width), max);
    }

    template <uint d, class IntS, class IntL>
    constexpr IntL point_to_index(const point<d, IntS>& p, IntS width,
                                  IntL max) {
        static_assert(sizeof(IntS) <= sizeof(IntL),
                      "IntS must be smaller or equal to IntL");
        return point_helpers<d, IntL>::point_to_index(point<d, IntL>(p),
    ...
    constexpr point<d, IntS> index_to_point(IntL index, IntS width, IntL max) {
        static_assert(sizeof(IntS) <= sizeof(IntL),
                      "IntS must be smaller or equal to IntL");
        return point<d, IntS>(
            point_helpers<d, IntL>::index_to_point(index, IntL(width), max));
    }
}  // namespace fsh
